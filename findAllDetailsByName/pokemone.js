	// variable which has all the details of all pokemon
...
}	//end of pokemonData object


var pokemonDetail = function(entername , pokemonData)  //creating a function which takes the pokemon name as argument i.e pokemondDetail
{

				var isPokemonfound = false; 

	                     for(currentPokemon in pokemonData.pokemon)   //for loop to find the name in var pokemonData 
{

	                     		if(pokemonData.pokemon[currentPokemon].name == entername)	//if condition to check which pokemon has that name 
{

							isPokemonfound = true;

	                                        alert("id is "+pokemonData.pokemon[currentPokemon].id);
						alert("Num is "+pokemonData.pokemon[currentPokemon].num);
						alert("Name is "+pokemonData.pokemon[currentPokemon].name);
						alert("Img id is "+pokemonData.pokemon[currentPokemon].img);
						alert("Type is "+pokemonData.pokemon[currentPokemon].type);
						alert("Height is "+pokemonData.pokemon[currentPokemon].height);
						alert("Weight is "+pokemonData.pokemon[currentPokemon].weight);
						alert("Candy is "+pokemonData.pokemon[currentPokemon].candy);
						alert("Candy count is "+pokemonData.pokemon[currentPokemon].candy_count);
						alert("Egg is "+pokemonData.pokemon[currentPokemon].egg);
						alert("Spawn chance is "+pokemonData.pokemon[currentPokemon].spawn_chance);
						alert("Average spawn is "+pokemonData.pokemon[currentPokemon].avg_spawns);
						alert("Spawn time is "+pokemonData.pokemon[currentPokemon].spawn_time);
						alert("Multiplier is "+pokemonData.pokemon[currentPokemon].multipliers);
						alert("Weaknesses is "+pokemonData.pokemon[currentPokemon].weaknesses);
						alert("Next evaluation is "+JSON.stringify(pokemonData.pokemon[currentPokemon].next_evolution,null));
						alert("Previous evalaution is "+JSON.stringify(pokemonData.pokemon[currentPokemon].prev_evolution,null));

	                     			break;
		}}
						if(isPokemonfound == false)	//if condition if given pokemon not found
{
...
var pokemonCheck = window.prompt("enter the name of the Pokemone");	//variable which take the pokemon name as input

pokemonDetail(pokemonCheck , pokemonData);	//calling the function